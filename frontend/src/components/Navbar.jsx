  ...
  return (
    <section>
      ...
      <div className='p-1 pl-10 bg-lactic h-14 flex items-center'>
        <Link to='/home' className='font-light text-3xl text-white'>BonBon</Link>
        <motion.div className='ml-[400px]'
          ...
          <Link to='/cart' className='text-center cursor-pointer h-12 mt-5 ml-10 text-xl font-mono text-white transition ease-out hover:text-orange-300'>Корзина</Link>
        </motion.div>
      </div>
    </section>
  )
