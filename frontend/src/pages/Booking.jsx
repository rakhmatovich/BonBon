        ...
        <div className='w-2/4 my-6 flex items-center justify-center'>
          <form className="w-full max-w-lg">
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
              ...
              <Link to='/hall' className="w-[250px] h-[44px] ml-1 text-center mt-6 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                Book
              </Link>
            </div>
          </form>
